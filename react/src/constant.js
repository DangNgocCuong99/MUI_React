...
export const LIMIT = 66;

export const PAGING_PRODUCT_REQUEST = 'PAGING_PRODUCT_REQUEST';
export const PAGING_PRODUCT_SUCCESS = 'PAGING_PRODUCT_SUCCESS';
export const PAGING_PRODUCT_FAILURE = 'PAGING_PRODUCT_FAILURE';